...
import { PantherPerfectScrollbarGeometry, PantherPerfectScrollbarPosition } from '@panther/directives/panther-perfect-scrollbar/panther-perfect-scrollbar.interfaces';
import { PantherConfigService } from '@panther/services/config.service';

@Directive({
    selector: '[pantherPerfectScrollbar]'
})
export class PantherPerfectScrollbarDirective implements OnInit, AfterViewInit, OnDestroy {
     ...
     * @param prefix
     */
    geometry(prefix: string = 'scroll'): PantherPerfectScrollbarGeometry {
        return new PantherPerfectScrollbarGeometry(
     ...
     * @param absolute
     */
    position(absolute: boolean = false): PantherPerfectScrollbarPosition {
        if (!absolute && this.ps) {
            return new PantherPerfectScrollbarPosition(
                this.ps.reach.x || 0,
                this.ps.reach.y || 0
            );
        }
