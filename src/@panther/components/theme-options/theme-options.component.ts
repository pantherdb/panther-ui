...
@Component({
    selector: 'panther-theme-options',
    templateUrl: './theme-options.component.html',
    styleUrls: ['./theme-options.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: pantherAnimations
})
export class PantherThemeOptionsComponent implements OnInit, OnDestroy {
    pantherConfig: any;
    form: FormGroup;
    ...
    ngOnInit(): void {
        ...
        this.form.valueChanges
            ...
            .subscribe((config) => {
                ...
                // Update the config
                this._pantherConfigService.config = config;
            });
    ...
    private _resetFormValues(value): void {
        switch (value) {
            ...
            // Horizontal Layout #1
            case 'horizontal-layout-panther':
                {
                    this.form.patchValue({
                        layout: {
                            width: 'fullwidth',
