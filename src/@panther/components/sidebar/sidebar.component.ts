...
import { PantherSidebarService } from './sidebar.service';
...
@Component({
    selector: 'panther-sidebar',
    templateUrl: './sidebar.component.html',
    styleUrls: ['./sidebar.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class PantherSidebarComponent implements OnInit, OnDestroy {
    // Name
    @Input()
    name: string;
     ...
     * @param {PantherSidebarService} _pantherSidebarService
    ...
    ngOnInit(): void {
        ...
        this._pantherConfigService.config
            ...
            .subscribe((config) => {
                this._pantherConfig = config;
            });

        // Register the sidebar
        this._pantherSidebarService.register(this.name, this);
    ...
    ngOnDestroy(): void {
        ...
        this._pantherSidebarService.unregister(this.name);
    ...
    private _showBackdrop(): void {
        ...
        this._backdrop.classList.add('panther-sidebar-overlay');

        // Add a class depending on the invisibleOverlay option
        if (this.invisibleOverlay) {
            this._backdrop.classList.add('panther-sidebar-overlay-invisible');
        }
