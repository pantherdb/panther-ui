...
export const PANTHER_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR: any = {
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => PantherMaterialColorPickerComponent),
    multi: true
};

@Component({
    selector: 'panther-material-color-picker',
    templateUrl: './material-color-picker.component.html',
    styleUrls: ['./material-color-picker.component.scss'],
    animations: pantherAnimations,
    encapsulation: ViewEncapsulation.None,
    providers: [PANTHER_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR]
})
export class PantherMaterialColorPickerComponent implements ControlValueAccessor {
    colors: any;
    hues: string[];
    view: string;
    selectedColor: any;
    ...
    set color(value) {
        ...
        // Split the color value (red-400, blue-500, panther-navy-700 etc.)
