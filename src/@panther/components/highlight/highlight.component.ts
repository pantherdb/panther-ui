...
import '@panther/components/highlight/prism-languages';

@Component({
    selector: 'panther-highlight',
    template: '',
    styleUrls: ['./highlight.component.scss']
})
export class PantherHighlightComponent implements OnInit, OnDestroy {
    // Source
    ...
    highlight(sourceCode): void {
        ...
        // can be formatted properly while using panther-highlight
        // component
