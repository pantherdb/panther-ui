...
import { PantherAdvancedSearchComponent } from './advanced-search/advanced-search.component';
...
export class SearchBarService {
    ...
    private attachDialogContainer(overlayRef: OverlayRef, config: AdvancedSearchDialogConfig, dialogRef: AdvancedSearchOverlayRef) {
        ...
        const containerPortal = new ComponentPortal(PantherAdvancedSearchComponent, null, injector);
        const containerRef: ComponentRef<PantherAdvancedSearchComponent> = overlayRef.attach(containerPortal);
