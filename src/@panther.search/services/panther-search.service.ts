...
export class PantherSearchService {
    ...
    constructor(
        ...
        this.states = this.pantherFormConfigService.modelState.options;
    ...
    setup() {
        ...
        self.pantherDataService.loadOrganisms();

        self.pantherDataService.onOrganismsChanged
            .subscribe(organisms => {
    ...
    addCam(res) {
        ...
        res.models.forEach((response) => {
            ...
            cam.graph = null;
            cam.id = modelId;
            cam.state = self.pantherFormConfigService.findModelState(response.state);
            ...
            cam.contributors = <Contributor[]>response.contributors.map((orcid) => {
                const contributor = find(self.pantherUserService.contributors, (inContributor: Contributor) => {
